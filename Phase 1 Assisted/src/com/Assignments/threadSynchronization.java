...
public class threadSynchronization extends Thread
{
		...
		public void run(){  
		 ...
		 public static void main(String args[]){  
			 ...
			 threadSynchronization m1=new threadSynchronization();  
			 threadSynchronization m2=new threadSynchronization();  
			 threadSynchronization m3=new threadSynchronization();
